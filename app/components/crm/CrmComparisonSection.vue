...
const otherColumns = ['saas', 'nocode'] as const
</script>
        ...
        <table class="w-full border-collapse text-left">
          <thead>
            <tr class="border-b border-[var(--border-subtle)]">
              ...
              >
                {{ t('crm_offer.comparison.columns.criteria') }}
              </th>
              <th
              ...
              >
                {{ t(`crm_offer.comparison.columns.${column}`) }}
              </th>
              <th class="bg-[var(--bg-primary)] px-6 py-5">
                <span class="flex items-center gap-2 font-manrope text-base font-semibold text-[var(--text-primary)]">
                  ...
                  {{ t('crm_offer.comparison.columns.studio') }}
                </span>
              </th>
            </tr>
          </thead>
          <tbody>
            ...
            >
              ...
              >
                {{ t(`crm_offer.comparison.rows.${key}.label`) }}
              </th>
              <td
                v-for="column in otherColumns"
                :key="column"
              ...
              >
                {{ t(`crm_offer.comparison.rows.${key}.${column}`) }}
              </td>
              <td class="bg-[var(--bg-primary)] px-6 py-4">
                <span class="flex items-start gap-2 font-inter text-sm font-medium text-[var(--text-primary)]">
                  <UIcon
                    ...
                    aria-hidden="true"
                  />
                  {{ t(`crm_offer.comparison.rows.${key}.studio`) }}
                </span>
              </td>
            </tr>
          </tbody>
