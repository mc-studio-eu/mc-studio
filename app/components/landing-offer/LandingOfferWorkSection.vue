...
// Only the projects that actually shipped a landing page or a marketing site
const landingProjects = computed(() =>
  projectData
    .filter((project) => project.categories.includes('landing-page'))
    .map((project) => ({
      slug: project.slug,
      title: project.title,
      image: project.image,
      ...
      <div class="grid grid-cols-1 gap-5 md:grid-cols-2 md:gap-6">
        ...
        >
          <NuxtLink
            ...
            :aria-label="`${t('landing_offer.work.cta')} — ${project.title}`"
          >
            <NuxtImg
              :src="project.image"
              :alt="project.title"
