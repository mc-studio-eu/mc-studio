  ...
  >
    ...
    <nav class="hidden lg:flex items-center gap-6">
      <a
        ...
        :key="item.key"
        :href="`#${item.id}`"
        class="font-inter text-sm font-medium text-[#ffffff] no-underline transition-colors duration-200 hover:text-[var(--color-gold)]"
      >
        {{ t(`landing_offer.nav.${item.key}`) }}
      </a>
    </nav>
    ...
    <div class="flex items-center gap-2 shrink-0">
      <div class="hidden sm:flex items-center gap-0.5 rounded-lg bg-black/40 p-0.5 backdrop-blur-md">
        <button
          ...
          :class="language === lang ? 'bg-[rgba(255,255,255,0.9)] text-[#0f0f0f]' : 'text-[rgba(255,255,255,0.6)] hover:text-[#ffffff]'"
          @click="language = lang"
        >
          {{ lang }}
        </button>
      ...
      <div
        :class="[
          ...
          colorMode.value === 'dark'
            ...
            : 'bg-[rgba(255,255,255,0.95)] shadow-[0_8px_32px_rgba(15,15,15,0.12),0_2px_8px_rgba(120,90,20,0.1),inset_0_0_0_1px_rgba(15,15,15,0.06)]'
        ]"
      >
                ...
                :class="[
                  ...
                  language === lang
                    ? colorMode.value === 'dark'
                      ...
                      : 'bg-[#ffffff] text-[#0f0f0f] shadow-sm'
                    : colorMode.value === 'dark'
