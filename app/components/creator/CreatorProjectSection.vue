        ...
        <div class="flex flex-col md:flex-row md:items-start gap-8">
          ...
          <div class="flex flex-col gap-4">
            ...
            <a ref="projectCtaBtn"
               ...
               target="_blank"
               class="cta-primary flex items-center justify-center border-none rounded-xl font-inter font-semibold text-sm text-[#0f0f0f] cursor-pointer backdrop-blur-[12px] transition-all duration-200 hover:brightness-105 no-underline"
            >
