      ...
      >
        ...
        >
          <div class="flex items-center justify-between gap-2 md:gap-3">
            ...
            >
              <NuxtImg src="/img/main/founder.jpeg" alt="MC Studio" class="w-6 h-6 md:w-7 md:h-7 rounded-lg bg-gradient-to-br from-[#f0bf6c] to-[#e8a84c] flex items-center justify-center font-inter font-semibold text-[9px] md:text-[10px] text-[#0f0f0f] object-contain" />
          ...
          >
            <div class="flex flex-col gap-4">
              ...
              >
                ...
                >
                  <NuxtImg src="/img/main/founder.jpeg" alt="MC Studio" class="w-6 h-6 md:w-7 md:h-7 object-contain rounded-lg flex items-center justify-center font-inter font-semibold text-[10px] text-[#0f0f0f]" />
                  <div class="flex flex-col items-start gap-px">
                    <span class="text-slide-container h-[14px]">
