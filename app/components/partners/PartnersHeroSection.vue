...
<template>
  ...
  >
    <!-- Background: CSS ivory/gold wash in light mode, bronze raster in dark mode -->
    <div class="hero-backdrop absolute inset-0 rounded-lg"></div>
    <ClientOnly>
      <NuxtImg
    ...
    >
      ...
      >
        <div
          class="inline-flex items-center gap-2 rounded-full px-3 py-1 bg-[var(--bg-card)] backdrop-blur-md border border-[var(--border-color)] shadow-[var(--card-shadow)]"
        >
          <span class="h-1.5 w-1.5 rounded-full bg-[var(--color-gold)]"></span>
          <span class="font-inter text-[11px] uppercase tracking-[0.16em] text-[var(--text-secondary)]">
        ...
        <div class="space-y-5">
          <h1
            class="w-full text-center hero-title font-manrope font-medium leading-[1.15] sm:leading-[1.2] md:leading-tight text-gradient text-[clamp(1.25rem,6vw,1.5rem)] min-[480px]:text-[clamp(1.5rem,5vw,1.75rem)] sm:text-[clamp(2rem,4.5vw,2.25rem)] md:text-[clamp(2.25rem,4vw,2.625rem)] lg:text-[2.625rem] xl:text-[3rem] opacity-0"
            style="filter: blur(20px); transform: translateY(20px)"
          >
            {{ t('partners.hero.title') }}
          </h1>
          <p
            class="w-full text-center hero-subtitle font-normal leading-[1.6] sm:leading-[1.7] tracking-wide text-[var(--text-secondary)] text-[clamp(0.8125rem,2.5vw,0.875rem)] sm:text-[clamp(0.875rem,2vw,1rem)] md:text-base lg:text-[1.0625rem] xl:text-[1.1875rem] opacity-0"
        ...
        <div class="flex flex-col sm:flex-row items-center sm:items-center justify-center gap-4 sm:gap-5">
          ...
          <button
            ...
            type="button"
            class="secondary-btn border-none group flex items-center justify-center gap-2.5 px-5 py-2.5 rounded-xl font-medium text-sm text-[var(--text-primary)] cursor-pointer transition-all duration-300 no-underline bg-[var(--bg-card)] border border-[var(--border-color)] shadow-[var(--card-shadow)] hover:brightness-95"
        ...
        >
          <div
            class="col-span-2 rounded-xl border border-[var(--border-color)] bg-[var(--bg-card)] shadow-[var(--card-shadow)] backdrop-blur-xl px-4 py-4 flex items-center justify-between gap-3"
          >
            <div class="space-y-1">
              <p class="font-inter text-[11px] uppercase tracking-[0.16em] text-[var(--text-muted)]">
                {{ t('partners.hero.example_label') }}
              </p>
              <p class="font-inter text-sm sm:text-[15px] text-[var(--text-secondary)]" v-html="t('partners.hero.example_text')">
              </p>
            </div>
          </div>

          <div
            class="rounded-xl border border-[var(--border-color)] bg-[var(--bg-card)] shadow-[var(--card-shadow)] backdrop-blur-xl px-4 py-4 flex flex-col justify-center"
          >
            <p class="font-inter text-[11px] uppercase tracking-[0.16em] text-[var(--text-muted)]">
            ...
            <p class="font-inter text-[11px] text-[var(--text-muted)] mt-1">
